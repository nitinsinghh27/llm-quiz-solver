...
1. Scraping a website (which may require JavaScript) for information
2. Sourcing from an API (with API-specific headers provided where required)
3. Cleansing text / data / PDF / … you retrieved
4. Processing the data (e.g. data transformation, transcription, vision)
5. Analysing by filtering, sorting, aggregating, reshaping, or applying statistical / ML models. Includes geo-spatial / network analysis
6. Visualizing by generating charts (as images or interactive), narratives, slides
